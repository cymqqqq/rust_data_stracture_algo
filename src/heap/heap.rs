...
impl Heap{
    ...
    pub fn insert(&mut self, x: i32) -> bool {
        ...
        //child node great than parent node, swap them
        //build heap bottom-top
    ...
    pub fn remove_max(&mut self) -> Option<i32> {
        ...
        //move the last leaf node to top heap
    ...
    fn heapify(&mut self) {
        ...
        loop {
            ...
            if (2 * idx + 1) as i32 <= self.count && self.data[max_pos] < self.data[2 * idx + 2] {max_pos = 2 * idx + 2; }
